...
%Abbreviations
		...
		type=abbr,
		name={MPD},
		description={Mean Percentage Difference}}		
...
\part{Research} % Please edit this biz, a different name?

\include{P2_Ch_Methodology}

\include{P2_Ch_Results}

\include{P2_Ch_AnalysisAndDiscussion} %perhaps analysis and discussion should go together?

\include{P3_Ch_Conclusion} %should this be external to the parts of the thesis?
