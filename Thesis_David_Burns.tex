...
% Title: The title that appears in the report is edited here.
	...
	% Discipline of Nanotechnology and Molecular Science, School of Chemistry, Physics and Mechanical Engineering, Science and Engineering Faculty,
...
\include{P0_Ch_Declaration}

\include{P0_Ch_Abstract}

\include{P0_Ch_Acknowledgements}
...
\include{P1_Ch_Introduction}

\include{P1_Ch_Atmosphere}

\include{P1_Ch_Dimethylsulfide}

% \include{P1_Ch_GBR}

% \include{P1_Ch_Modelling}

% \include{P1_Ch_DMSClimatology}

% \include{P1_Ch_Summary}

%-------------------------------------------------------------------------------------------------%

\part{Research} % Please edit this biz 

\include{P2_Ch_Methodology}

\include{P2_Ch_Results}

\include{P2_Ch_Analysis}

\include{P2_Ch_Discussion} %perhaps analysis and discussion should go together?

\include{P2_Ch_FutureResearch} %you could fold this into the discussion if it doesnt end up being very long
