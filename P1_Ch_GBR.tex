...
%------------------------------------------------------------------------------------------------------------------
	...
	\begin{figure}[!htb]
	 	\centering
	    \includegraphics[width=0.7\textwidth,natwidth=1122,natheight=888]{Fig/Literature_Review/coraldmspconcvstemp.png}
...
%------------------------------------------------------------------------------------------------------------------
 ...
 \label{sec:gbrdms}
	...
	\begin{figure}[!htb]
	 	\centering
	    \includegraphics[width=0.9\textwidth,natwidth=1782,natheight=664]{Fig/Literature_Review/DMS_tidal_link.png}
